<template>
  <div class="rounded-medias relative grid w-full gap-3 text-left">
    ...
    <div class="text-xs">
      <ul class="flex w-full flex-wrap gap-4 text-left">
        <li v-for="component in components" :key="component.id" class="surface-muted flex-1 rounded-media p-4 shadow-md">
